...
Projects
------
<span style="color: #BA68C8; display:block; margin-bottom:0.25rem;">Encoding speaker's negative bias: The semantics and pragmatics of <i>wh</i>-polar questions</span>  
...
<span style="color: #BA68C8; display:block; margin-bottom:0.25rem;">The syntax of existential locatives and possessives in Korean and Japanese</span>  
- examines the argument structure of locative and possessive constructions that use an existential predicate: <i>iss-</i> in Korean and <i>aru/iru</i> in Japanese.
- shows that distinct analyses provide more systematic and unified accounts than previous uniform analyses.
<br><br>

<span style="color: #BA68C8; display:block; margin-bottom:0.25rem;">The scope (un-)ambiguity in Korean: evidence from doubly quantified sentences</span>  
